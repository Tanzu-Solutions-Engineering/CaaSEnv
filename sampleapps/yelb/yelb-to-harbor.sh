...
docker tag mreferre/yelb-appserver:0.5  harbor-ctrl.caas.pez.pivotal.io/library/yelb-appserver:0.5
...
docker push harbor-ctrl.caas.pez.pivotal.io/library/yelb-appserver:0.5
